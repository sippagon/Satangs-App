...
import 'edit_taxes_page_model.dart';
export 'edit_taxes_page_model.dart';

class EditTaxesPageWidget extends StatefulWidget {
  const EditTaxesPageWidget({
    super.key,
    required this.guid,
  });
  ...
  @override
  State<EditTaxesPageWidget> createState() => _EditTaxesPageWidgetState();
}

class _EditTaxesPageWidgetState extends State<EditTaxesPageWidget> {
  late EditTaxesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditTaxesPageModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      safeSetState(() {
        _model.nameTextFieldTextController?.text =
            FFAppState().Taxes[_model.updateIndex!].name;
        _model.nameTextFieldTextController?.selection = TextSelection.collapsed(
            offset: _model.nameTextFieldTextController!.text.length);
      });
      safeSetState(() {
        _model.taxYearTextFieldTextController?.text =
            FFAppState().Taxes[_model.updateIndex!].year;
        _model.taxYearTextFieldTextController?.selection =
            TextSelection.collapsed(
                offset: _model.taxYearTextFieldTextController!.text.length);
      });
    });
