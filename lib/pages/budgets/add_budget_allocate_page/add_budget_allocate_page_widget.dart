...
import 'add_budget_allocate_page_model.dart';
export 'add_budget_allocate_page_model.dart';

class AddBudgetAllocatePageWidget extends StatefulWidget {
  const AddBudgetAllocatePageWidget({super.key});

  @override
  State<AddBudgetAllocatePageWidget> createState() =>
      _AddBudgetAllocatePageWidgetState();
}

class _AddBudgetAllocatePageWidgetState
    extends State<AddBudgetAllocatePageWidget> {
  late AddBudgetAllocatePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddBudgetAllocatePageModel());
                                              ...
                                              itemBuilder: (context,
                                                ...
                                                return wrapWithModel(
                                                  ...
                                                  child:
                                                    ...
                                                    key: Key(
                                                      'Keydlb_${listViewItemsItem.guid}',
                                                    ),
                                                    updateIndex:
                                                        listViewItemsIndex,
                                                    elementGuid:
