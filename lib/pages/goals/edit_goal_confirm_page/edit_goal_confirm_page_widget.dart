...
import 'edit_goal_confirm_page_model.dart';
export 'edit_goal_confirm_page_model.dart';

class EditGoalConfirmPageWidget extends StatefulWidget {
  const EditGoalConfirmPageWidget({
    super.key,
  ...
  @override
  State<EditGoalConfirmPageWidget> createState() =>
      _EditGoalConfirmPageWidgetState();
}

class _EditGoalConfirmPageWidgetState extends State<EditGoalConfirmPageWidget> {
  late EditGoalConfirmPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditGoalConfirmPageModel());
                                            ...
                                            FFAppState().updateGoalsAtIndex(
                                              ...
                                              (e) => e
                                                ..name = FFAppState()
                                                    .TempGoalFormInput
                                                    .name
                                                ..targetAmount = FFAppState()
                                                    .TempGoalFormInput
                                                    .targetAmount
                                                ..currentBalance = FFAppState()
                                                    .TempGoalFormInput
                                                    .currentBalance
                                                ..targetDate = FFAppState()
                                                    .TempGoalFormInput
                                                    .targetDate
