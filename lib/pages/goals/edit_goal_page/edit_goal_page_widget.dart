...
class _EditGoalPageWidgetState extends State<EditGoalPageWidget> {
  ...
  void initState() {
    ...
    _model.textController2 ??= TextEditingController(
        text: FFAppState().TempGoalFormInput.targetAmount.toString());
    _model.textFieldFocusNode2 ??= FocusNode();

    _model.textController3 ??= TextEditingController(
        text: FFAppState().TempGoalFormInput.currentBalance.toString());
                                            ...
                                            onPressed: () async {
                                              ...
                                              if (_model.validName!) {
                                                ...
                                                ScaffoldMessenger.of(context)
                                                  ...
                                                  SnackBar(
                                                    content: Text(
                                                      'ชื่อ ${_model.textController1.text} มีการใช้งานแล้ว',
                                                      style: TextStyle(
                                                        color:
                                                            FlutterFlowTheme.of(
                                                                    context)
