...
import 'edit_goal_income_page_model.dart';
export 'edit_goal_income_page_model.dart';

class EditGoalIncomePageWidget extends StatefulWidget {
  const EditGoalIncomePageWidget({
    super.key,
  ...
  @override
  State<EditGoalIncomePageWidget> createState() =>
      _EditGoalIncomePageWidgetState();
}

class _EditGoalIncomePageWidgetState extends State<EditGoalIncomePageWidget> {
  late EditGoalIncomePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditGoalIncomePageModel());

    _model.textController1 ??= TextEditingController(
        text: FFAppState().TempGoalFormInput.monthlyIncome.toString());
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??= TextEditingController(
        text: FFAppState().TempGoalFormInput.monthlyExpense.toString());
    ...
    _model.textController4 ??= TextEditingController(
        text: FFAppState().TempGoalFormInput.incomeGrowthRate.toString());
