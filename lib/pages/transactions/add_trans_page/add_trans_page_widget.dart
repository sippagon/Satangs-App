...
import 'add_trans_page_model.dart';
export 'add_trans_page_model.dart';

class AddTransPageWidget extends StatefulWidget {
  const AddTransPageWidget({
    super.key,
  ...
  @override
  State<AddTransPageWidget> createState() => _AddTransPageWidgetState();
}

class _AddTransPageWidgetState extends State<AddTransPageWidget> {
  late AddTransPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddTransPageModel());
                                  ...
                                  onPressed: () async {
                                    ...
                                    if ((_model.categoryDDValue != null &&
                                      ...
                                      FFAppState()
                                        ...
                                        typeId: widget.transactionType?.name,
                                      ...
                                      _model.currentBalance =
                                          await actions.updateCurrentBalance(
                                        _model.accDDValue!,
                                      );
                                      _model.accountIndex =
                                          await actions.getAccountIndexByGuid(
                                        _model.accDDValue!,
                                      );
